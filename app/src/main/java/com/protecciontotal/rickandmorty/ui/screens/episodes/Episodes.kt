...
fun Episodes(
    ...
    Scaffold(
        topBar = {
            TopNavBarComponent(navController, stringResource(id = R.string.episodes_title))
        },
                            ...
                            OutlinedCard(
                                ...
                                Row(
                                    ...
                                    Row(
                                        ...
                                        Column {
                                            Text(
                                                text = "Episode ${episode.id}: ${episode.name}",
                                                fontWeight = Medium,
                                                fontSize = 20.sp
                                            )
                                            Text(
...
@Composable
fun EpisodesPreview() {
    Episodes(navController = rememberNavController(), EpisodesViewModel())
}